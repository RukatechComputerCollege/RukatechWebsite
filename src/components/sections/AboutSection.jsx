...
export default function AboutSection() {
  ...
  return (
    <div className="w-full bg-[hsl(var(--primary))] overflow-hidden font-sans text-slate-900 relative">
      ...
      <div className="w-full h-screen relative flex flex-col">
        ...
        >
          <source src="/webm/herobg.webm" type="video/webm" />
        </video>
        {/* <div className="absolute inset-0 bg-black/40 pointer-events-none" /> */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col h-full relative z-10">
          {/* SECTION HEADER TAG */}
          <motion.div
            className="flex items-center justify-center gap-4 pt-22 pb-4"
          ...
          >
            ...
            >
              <motion.div
                className="absolute inset-0 bg-linear-to-r from-transparent via-red-500 to-transparent w-full"
                animate={{ x: ["-100%", "100%"] }}
            ...
            <div className="flex items-center gap-2 px-4 py-1.5 rounded-full border border-slate-100 bg-white shadow-sm">
              <div className="w-1.5 h-1.5 rounded-full bg-red-600 shadow-[0_0_8px_rgba(124,58,237,0.6)]" />
          ...
          >
            ...
            >
              <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 leading-[1.05] text-black">
                Architecting the{" "}
              ...
              <p className="text-xl text-gray-800 max-w-3xl mx-auto leading-relaxed">
                Hands-on computer training, industry-recognized certifications,
                and career services to launch and grow your career in software,
                IT, and data.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-40 w-full max-w-6xl">
              {[
                {
                  title: "The Dream",
                  desc: "Accessible, career-focused tech education that prepares learners for real roles in software, IT and data.",
                  icon: Star,
                ...
                {
                  title: "The Present",
                  desc: "Hands-on courses taught by industry practitioners with project-based learning and mentorship.",
                  icon: CheckCircle2,
                ...
                {
                  title: "The Future",
                  desc: "Adaptive curricula and career placement services that evolve with the tech landscape.",
                  icon: TrendingUp,
      ...
      <div className="w-full py-16 md:py-20 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="absolute left-1/2 top-[100vh] -translate-x-1/2 -translate-y-1/2 z-20 p-1 rounded-[2.5rem] bg-linear-to-r from-[hsl(var(--accent))] via-indigo-600 to-[hsl(var(--accent))] animate-gradient-x overflow-hidden shadow-2xl shadow-[hsl(var(--crent))] w-full max-w-6xl"
          >
              ...
              <div className="max-w-xl text-center md:text-left">
                <h2 className="text-sm md:text-3xl font-bold mb-4 text-slate-900">
                  Ready to launch your tech career?
                </h2>
                <p className="text-slate-500">
                  Enroll at Rukatech Computer College for hands-on training,
                  certifications, and career support to help you land your next role.
                </p>
              </div>
              ...
              <Dialog open={open} onOpenChange={setOpen}>
                <DialogTrigger asChild>
                  <Button
                    size="lg"
                    className="rounded-full px-4 md:px-10 py-2 md:py-7 text-sm md:text-lg bg-slate-900 hover:bg-black text-white shadow-xl transition-all hover:scale-105 active:scale-95 group shrink-0"
                  >
                    Get Started
      ...
      <div className="w-full py-16 lg:py-24 pt-28 lg:pt-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="absolute -bottom-12 left-1/2 -translate-x-1/2 flex items-center gap-4">
              ...
              <div className="flex gap-2">
                {images.map((_, i) => (
                  <div
                    key={i}
                    className={`w-2 h-2 rounded-full transition-all duration-300 ${i === activeIndex ? "w-6 bg-[hsl(var(--accent))]" : "bg-slate-200"}`}
                  />
                ))}
              </div>
              <Button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            >
              <h2 className="text-3xl font-bold leading-tight">
                Your Trusted Tech Education Partner
              </h2>
              <p className="text-slate-500 leading-relaxed">
                Rukatech Computer College blends practical curriculum,
                industry partnerships, and career services to support learners
                into meaningful tech roles.
              </p>
              <Button
                variant="outline"
            ...
            >
              <Card className="p-8 rounded-4xl bg-linear-to-br from-[hsl(var(--accent))] to-[hsl(var(--crent))] text-white border-0 shadow-2xl shadow-violet-900/20 relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  <div className="mb-8">
                    ...
                    <p className="text-violet-100 opacity-90">
                      Project-based training, mentorship, and hands-on labs to
            ...
            >
              <Card className="p-8 rounded-4xl bg-white border-slate-100 shadow-xl shadow-[hsl(var(--accent))] hover:shadow-2xl hover:shadow-[hsl(var(--crent))] transition-all duration-300">
                <div className="flex items-start justify-between mb-6">
                  <div>
                    ...
                    <p className="text-sm text-slate-400 mt-1">
                      Learner performance dashboards and weekly progress summaries
                    </p>
                  </div>
